    ...
    homeContent.innerHTML =
       ...
       <div id="image" class="w-full  rounded-2xl h-full relative">
        <div class="absolute z-10 w-full text-center p-4 h-full top-16">
         ...
         <p class="text-sm italic text-white mb-3">"Math Brain adalah aplikasi pembelajaran berbasis web yang didesain untuk membantu siswa memahami materi aritmatika sosial secara lebih mudah dan menyenangkan. "</p>
         <a href="#materi-real" class="bg-yellow-300 font-bold  py-1 px-4 rounded-xl shadow-md ">
        Baca sekarang <i class="text-xs fas fa-arrow-right"></i>
         </a>
        </div>
      </div>
     </div>
...
<div class="mt-4 bold w-full font-sans">
 <div class="flex w-full">
   <a href="#materi" class="block w-1/2 bg-white  rounded shadow-xl mr-2 p-4 menu border">
   ...
   <a href="../quiz.html" class="block w-1/2 bg-white  rounded shadow-xl mr-2 p-4 menu border">
     <div class="flex justify-center w-full">
 ...
 <div class="flex w-full mt-2">
   <a href="#daftar-pustaka" class="block w-1/2 bg-white rounded shadow-xl mr-2 p-4 menu border">
   <div class="flex justify-center w-full">
 ...
 <p class="text-xs text-center">Referensi yang digunakan</p>
   ...
   <div class="flex justify-center w-full">
    ...
    typewriter
        ...
        .pauseFor(1000)
        .start();
    document.title = 'Math Brain - Aritmatika Sosial'
}
